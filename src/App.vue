...
export default {
    ...
    provide:{
      richtexteditor: [Toolbar, Image, HtmlEditor, Link, Table, QuickToolbar ]
    }
  }
...
<template>
<ejs-richtexteditor ref="rteInstance" height="400px" width="700px" :toolbarSettings="customtoolbarSettings" :quickToolbarSettings="quickToolbarSettings">
